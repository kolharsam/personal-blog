...
> ##### NOTE:
> I will be using a mix of JavaScript & TypeScript across the post. I also assume that you can 
> comprehend those too. If that's not the case, let me know and I just might conjure up an example in > your favourite language (in case I know how to write it).
>
...
<Disqus
  config={{
      url: '/introduction-to-transducers',
